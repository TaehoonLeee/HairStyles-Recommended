...
def image_align(src_file, dst_file, face_landmarks, output_size=256, transform_size=4096, enable_padding=True):
        ...
        print("image align is started in GAN!")
        ...
        print("image align is finished in GAN!")




#python testzz.py /raw_images /aligned_images
...
#align_module('./raw_images', './aligned_images', 'ex.png')

if __name__ == '__main__':
    align_module('image/align', 'image/front', sys.argv[1])
